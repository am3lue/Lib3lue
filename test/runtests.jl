...
# !!! Main.UserApp is configured as an alias for Main.Library and you might encounter it in some tests
using Main.Library, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Library tests" begin
  @includetests ARGS
end
